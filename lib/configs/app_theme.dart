...
class AppTheme {
  static final _core = AppCoreTheme(
    shadowSub: const Color(0xff7149C6).withAlpha(100),
    primary: const Color(0xff7149C6),
    primaryLight: const Color(0xff7149C6).withAlpha(100),
  ...
  static AppCoreTheme dark = _core.copyWith(
    background: const Color(0xff2d2e32),
    backgroundSub: const Color(0xff2d2e32),
    scaffold: const Color(0xff2d2e32),
    text: Colors.white,
